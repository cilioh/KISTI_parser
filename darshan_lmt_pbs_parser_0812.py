...
'''
			...
			insertString = "INSERT INTO " + app_sqlite + " VALUES ('%s','%s','%s',%s,'%s','%s',%s,%s,%s,%s,%s, %s,%s, %s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s,%s,%s, %s,%s,%s,%s,%s,%s, %s,%s,%s,%s,%s,%s, %s,%s,%s,%s,%s, %s,%s,%s,%s,%s,%s,%s,%s,%s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s, %s,%s,%s,%s,%s, '%s',%s,%s,%s,%s,%s)" %(file,
				progName, userID, jobID, startTime, endTime, int(ioStartTime), runTime, numProc, numCPU, numNode,
				numOST, stripeSize,
				totalFile, totalIOReqPOSIX, totalMetaReqPOSIX,
				totalIOReqMPIIO, totalMetaReqMPIIO, totalIOReqSTDIO, totalMetaReqSTDIO,
